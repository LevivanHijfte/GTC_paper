...
allstates = annotation |> 
            ...
            filter(bioidentsintegrated %in% c("TAMs"))
...
glioma.integrated <- RunUMAP(object = glioma.integrated, reduction = "pca", dims = 1:20) # Again, you can play around with nrs of dims
glioma.integrated <- FindNeighbors(object = glioma.integrated, dims = 1:20)
glioma.integrated <- FindClusters(object = glioma.integrated, resolution = .5)

DefaultAssay(object = glioma.integrated) = "SCT"

saveRDS(glioma.integrated, "dir_TAM_subset.RDS")